...
@Component({
  ...
  template: `
    ...
    >
      ...
      <ng-container *ngSwitchCase="'italic'">
        <line x1="19" x2="10" y1="4" y2="4" />
        <line x1="14" x2="5" y1="20" y2="20" />
        <line x1="15" x2="9" y1="4" y2="20" />
      </ng-container>
      <ng-container *ngSwitchCase="'strike'">
      ...
      <ng-container *ngSwitchCase="'remove-formatting'">
        <path d="M4 7V4h16v3" />
        <path d="M5 20h6" />
        <path d="M13 4 8 20" />
        <path d="m15 15 5 5" />
      ...
      <ng-container *ngSwitchCase="'pilcrow'">
        <path d="M13 4v16" />
        <path d="M17 4v16" />
      ...
      <ng-container *ngSwitchCase="'list-ordered'">
        <path d="M10 12h11" />
        <path d="M10 18h11" />
        <path d="M10 6h11" />
        <path d="M4 10h2" />
      ...
      <ng-container *ngSwitchCase="'code-block'">
      ...
      <ng-container *ngSwitchCase="'horizontal-rule'">
        <path d="M5 12h14" />
      </ng-container>
      <ng-container *ngSwitchCase="'corner-down-left'">
      ...
      <ng-container *ngSwitchCase="'highlighter'">
      ...
      <ng-container *ngSwitchCase="'list-checks'">
      ...
      <ng-container *ngSwitchCase="'row-insert-above'">
        <rect width="18" height="6" x="3" y="15" rx="1" />
        <path d="M12 3v6" />
        <path d="M9 6h6" />
      </ng-container>
      <ng-container *ngSwitchCase="'row-insert-below'">
        <rect width="18" height="6" x="3" y="3" rx="1" />
        <path d="M12 15v6" />
        <path d="M9 18h6" />
      </ng-container>
      <ng-container *ngSwitchCase="'column-insert-left'">
        <rect width="6" height="18" x="15" y="3" rx="1" />
        <path d="M3 12h6" />
        <path d="M6 9v6" />
      </ng-container>
      <ng-container *ngSwitchCase="'column-insert-right'">
        <rect width="6" height="18" x="3" y="3" rx="1" />
        <path d="M15 12h6" />
        <path d="M18 9v6" />
      </ng-container>
      <ng-container *ngSwitchCase="'row-delete'">
        <rect width="18" height="6" x="3" y="9" rx="1" />
        <path d="m9 4 6 6" />
        <path d="m15 4-6 6" />
      </ng-container>
      <ng-container *ngSwitchCase="'column-delete'">
        <rect width="6" height="18" x="9" y="3" rx="1" />
        <path d="m4 9 6 6" />
        <path d="m4 15 6-6" />
      </ng-container>
      <ng-container *ngSwitchCase="'merge-cells'">
        <rect width="18" height="18" x="3" y="3" rx="2" />
        <path d="M8 12h8" />
        <path d="m10 9-2 3 2 3" />
        <path d="m14 9 2 3-2 3" />
      </ng-container>
      <ng-container *ngSwitchCase="'split-cell'">
        <rect width="18" height="18" x="3" y="3" rx="2" />
        <path d="M12 3v18" />
      </ng-container>
      <ng-container *ngSwitchCase="'table-header'">
        <rect width="18" height="18" x="3" y="3" rx="2" />
        <path d="M3 9h18" />
      ...
      <ng-container *ngSwitchCase="'align-justify'">
        <line x1="21" x2="3" y1="6" y2="6" />
      ...
      <ng-container *ngSwitchCase="'panel-right'">
        <rect width="18" height="18" x="3" y="3" rx="2" />
        <path d="M15 3v18" />
      </ng-container>
      <ng-container *ngSwitchCase="'indent-decrease'">
        <path d="M21 4H8" />
        <path d="M21 9H8" />
        <path d="M21 14H8" />
        <path d="M21 19H8" />
      ...
      <ng-container *ngSwitchCase="'indent-increase'">
        <path d="M21 4H8" />
        <path d="M21 9H8" />
        <path d="M21 14H8" />
        <path d="M21 19H8" />
